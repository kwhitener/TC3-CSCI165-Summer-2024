...
public class Date{
	...
	/**
	 * Copy constructor to create a deep copy of a Date object
	 * @param toCopy
	 */
	public Date(Date toCopy){
		this.month	= toCopy.month;	// primitive
		this.day	= toCopy.day;	// primitive
		this.year	= toCopy.year;	// primitive
		this.format = toCopy.format;// enum
	}
