...
public class Student{
    ...
    public Student(String name, String major, Date dateEnrolled){
        ...
        if(dateEnrolled != null){
            ...
            Date grad   = new Date(dateEnrolled.getMonth(), dateEnrolled.getDay(), dateEnrolled.getYear()); // date enrolled
    ...
    */ 
    ...
    public Date getExpectedGrad() {
        return new Date(expectedGrad); // expectedGrad is PRIVATE
                            // return a copy
    }
    ...
    */
    public void setExpectedGrad(Date expectedGrad) {
        if (this.dateEnrolled != null && expectedGrad != null && expectedGrad.compareTo(this.dateEnrolled) > 0)
            this.expectedGrad = new Date(expectedGrad); // PRIVACY LEAK
    }
    ...
    */ 
    public String toString() {
        return  "Name:\t"       + name  +
                ...
                "\nYear:\t"     + year  +
                "\nGPA:\t"      + gpa   +
                "\nStart:\t"    + dateEnrolled  + // composition
                "\nEnd:\t"      + expectedGrad  + // composition
                "\nAdvisor:\t"  + advisor;
    }
